...
/**
 * A client for the Minotaur game, modified and extended from the
 ...
 * code.  In particular I created the TTTP (Minotaur Protocol)
...
public class TicTacToeClient {
    ...
    private TicTacToeClient(String serverAddress) throws Exception {
        ...
        try {
            ...
            JLabel label = new JLabel("Левая кнопка мыши - бросок");
            JLabel label2 = new JLabel("Правая кнопка мыши - завершение хода");
            JLabel label3 = new JLabel("Стрелки - движение");
